...
scale our presence and empower underserved communities across India.
      ...
      <FeatureSlider/>
<div className='text-2xl bg-gradient-to-r from-[#c9243f] to-[#faa619] text-transparent bg-clip-text font-extrabold mb-4 rounded-2xl mt-4>
'>SHAPEDBY RURAL INSIGHTS
        </div>
