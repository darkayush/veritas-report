...
recognition of performance. Our onground presence is strengthened by
...
<h1 className='text-xl text-[#c9243f] mb-2'>Building Capability through
Continuous Learning</h1>
<div className='mb-4'>
<p className='mb-2'>
At Veritas Finance, we believe that
strong field capability is the foundation of
responsible lending. Our sales and credit
personnel undergo rigorous training that
equips them with the skills to assess
borrowers using practical, on-ground
indicators such as inventory levels,
customer footfall and transaction patterns. 
</p>
<p className='mb-2'>
...
<h1 className='text-xl text-[#c9243f] mb-2'>Performance and Recognition </h1>
<div className='mb-4'>
<p className='mb-2'>
...
<div className='mb-4 md:w-[50%]'>
    <h1 className='text-xl text-[#c9243f] mb-2'>Engagement and Communication  </h1>
    <p className='mb-2'>
