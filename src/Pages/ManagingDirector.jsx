    ...
    <div className="marginal">
      ...
      <div className='md:!flex justify-start items-center my-5 bg-[#c9243f] rounded-2xl'>
        ...
        <div className='pl-10'>
          ...
          <p className='mt-4 text-2xl w-fit bg-[#f6a11d] text-transparent bg-clip-text font-semibold'>D. Arulmany</p>
          <p className="text-lg text-white">Managing Director and CEO</p>
      ...
      <div>
        <h1 className="font-bold text-[#c9243f] md:text-xl text-xl pt-1 mb-1">
          Dear Shareholders,
        </h1>
        ...
        <div>
          <div className="mb-4">
            ...
            <p className="mb-2">
              ...
              continuing to pursue our journey unfased.
              <br />
              <br />
          ...
          <div className="mb-4">
            <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>Operational and Financial Highlights</h1>
            <div>
              <div className="mb-3">
                <p className="mb-2">
                ...
                <p className="mb-2">
                  ...
                  by 28.39% to INR 7,349 crores, driven by disbursements of INR 3,933 crores,
                  a 6.23% increase from the previous
                  year. We reported a Profit After Tax
                  (PAT) of INR 295 crores, up from INR
          ...
          <div className="mb-4">
            <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>Technology and
            ...
            <p className="mb-2">
              ...
              efficiency and loan rejection rates. Our enhanced cloud infrastructure,
          ...
          <div className="mb-4">
            <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>Strategic Roadmap
              and Vision 2028</h1>
            <p className="mb-2">
              As we complete our 10th year and
              enter the 11th, we also realise that we
              are very close to reaching a significant
              milestone of INR 10,000 crores Loan
              book. All our products are on a
          ...
          <div className="mb-4">
            <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>Corporate Social Responsibility
            ...
            <p className="mb-2">
              ...
              to our strategy. Our ESG journey will evolve through collaboration, learning,
      ...
      <div className="mt-4 mb-3">
        <p>With Regards,</p>
        <p className="md:text-3xl text-xl mt-4 bg-gradient-to-r from-[#c9243f] to-[#eb8a2b] bg-clip-text text-transparent font-semibold w-fit">
          D. Arulmany
        </p>
        <p className="">
