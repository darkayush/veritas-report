  ...
  return (
    <div className='sm:w-full marginal'>
      ...
      <div className='flex justify-center'>
        <img src="/home/Onlypicture.png" alt=""
          className='lg:max-w-[77%] rounded-2xl mb-5' />
      </div>
      <div className='flex justify-center'>
        <div className='lg:max-w-[77%]'>
          <h1 className='text-2xl font-bold mb-5'>Board & Investors</h1>
          <p className='text-md'>
            <span className='font-semibold'>From left bottom:</span> Mr. Sudhir Variyar, Nominee Director - Multiples, Mr. Niren Shah - Managing Director and the Head of Norwest India, Mr. D. Arulmany - Managing Director and CEO, Mr. Raj Vikash Verma, Chairman and Non-Executive Independent Director, Mr. Sankarson Banerjee, Non-Executive Independent Director, and Mr. Shiv Chaudhary, Managing Director - Norwest India
            <br /><br />
            <span className='font-semibold'>From left top:</span> Mr. Parin Mehta, Nominee Director - Kedaara Capital, Ms. Priyamvada Ramkumar, Nominee Director - Lok Capital, Mr. Mathew Joseph - Non-Executive Independent Director, Dr. Susan Thomas - Non-Executive Independent Director, Mr. Suresh Subramanian, Non-Executive Independent Director.
          </p>
        </div>
      </div>
