const Chairman = () => {
  return (
    <div className="marginal">
      <h1 className="font-bold text-[#3c3a39] md:text-4xl text-3xl pt-1 mb-10">Chairman’s Message</h1>
      <div className='md:!flex justify-start items-center my-5 bg-[#c9243f] rounded-2xl'>
        ...
        <div className='md:w-[70%] pl-10'>
          <p className='md:text-2xl text-white font-semibold md:w-[95%] '>
            "Our strategic priorities are
            anchored in the balance
            between scale and control,
            growth and governance and
            innovation and stability. We
            are focused on broadening
            our product portfolio,
            deepening our distribution
            reach and strengthening
            our institutional capabilities
            in a way that allows
            us to stay agile in a
            dynamic environment."
          </p>
          <p className='mt-4 text-2xl w-fit bg-[#f6a11d] text-transparent bg-clip-text font-semibold'>Raj Vikash Verma</p>
          <p className="text-lg text-white">Chairman and Non-Executive
      ...
      <div>
        <h1 className="font-bold text-[#c9243f] md:text-xl text-xl pt-1 mb-2">
          Dear Shareholders,
        </h1>
        ...
        <div className='mb-3'>
          <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>What Drives Us </h1>
          <div><p className="mb-2">
            At Veritas, our Mission is to make a
            difference and create a positive impact
            in the lives of informal customers of
            MSMEs through sustainable financing
        ...
        <div className='mb-3'>
          <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>Performance and Progress </h1>
          <div><p className="mb-2">
            Despite global macroeconomic
            uncertainties, the Indian economy
            maintained its momentum, and so did
            we. As of March 31, 2025, our loan book
            stood at INR 7,349 crores, supported by huge disbursements and a growing
            customer base of entrepreneurs,
            consciously promoted and served by us
            in view of their huge potential to serve
            the broader economy. We expanded
            our physical presence across over 10
        ...
        <div className='mb-3'>
          <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>Strategic Priorities
            and Growth Outlook</h1>
          <div><p className="mb-2">
            As we look ahead, we see the NBFC
            sector entering a phase of greater
            responsibility and sharper focus on the
            growth of the economy, with the NBFCs
            playing a definitive role in meeting the
            credit demands in the economy. With
            deeper credit penetration, stronger
            regulatory frameworks and more
            sophisticated risk and technology
            practices emerging across the industry,
            the opportunity for Veritas has never
            been more promising. The MSME
            financing space, in particular, stands at
            the cusp of huge growth and expansion
            as this market segment continues to
            be grossly underserved, and far from
            saturation, yet full of potential and
            promise. This dichotomous challenge
        ...
        <div className='mb-3'>
          <h1 className='text-xl text-[#c9243f] mb-2 font-bold'>Together Towards Purpose</h1>
          <div>
            <p className="mb-2">
        ...
        <div className="mt-4 mb-3">
          <p>With Regards,</p>
          <p className="md:text-3xl text-xl mt-4 bg-gradient-to-r from-[#c9243f] to-[#eb8a2b] bg-clip-text text-transparent font-bold w-fit">
            Raj Vikash Verma
          </p>
          <p className="">
